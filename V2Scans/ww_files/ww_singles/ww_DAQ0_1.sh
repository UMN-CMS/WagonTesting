...
./wagoneer.py --scan > DAQScans/0/DAQ0_12_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_13_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_14_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_15_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_16_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_17_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_18_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_19_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_110_${sn}_fc.csv
...
./wagoneer.py --scan > DAQScans/0/DAQ0_111_${sn}_fc.csv
