...
class ADC(Test):
    ...
    def __init__(self, conn, board_sn=-1, tester='', device=3, bus=1, cshigh=True, max_speed=5000000, read_reg=False, write_reg=False, register=None, value=None):
    ...
    def adc(self, **kwargs):
        ...
        if result1 > 0.01:
            passed_list[0] = False
        self.test_data["test_1"] = {"Passed": passed_list[0], "Result": f'{result1:.3f} volts', "Raw_Result": str(thisADS124.read_data())}
        
        print(self.test_data["test_1"])
        print('-------------------------------------------------------')
        ...
        if result2 >= 100 or result2 <= 80:
            passed_list[1] = False
        self.test_data["test_2"] = {"Passed": passed_list[1], "Result": f'{result2:.3f} degrees (F)', "Raw_Result": str(thisADS124.read_data())}
        print(self.test_data["test_2"])
        print('-------------------------------------------------------')
        ...
        if result3 >= 0.84 or result3 <= 0.82:
            passed_list[2] = False
        self.test_data["test_3"] = {"Passed": passed_list[2], "Result": f'{result3:.3f} volts', "Raw_Result": str(thisADS124.read_data())}
        print(self.test_data["test_3"])
        print('-------------------------------------------------------')
        ...
        if result4 >= 0.84 or result4 <= 0.82:
            passed_list[3] = False
        self.test_data["test_4"] = {"Passed": passed_list[3], "Result": f'{result4:.3f} volts', "Raw_Result": str(thisADS124.read_data())}
        print(self.test_data["test_4"])
        print('-------------------------------------------------------')
