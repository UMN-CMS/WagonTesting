...
class ADC(Test):
    ...
    def __init__(self, conn, board_sn=-1, tester='', device=3, bus=3, cshigh=False, max_speed=5000000, read_reg=False, write_reg=False, register=None, value=None):
    ...
    def adc(self, **kwargs):
        ...
        self.conn.send("Starting ADC self test")

        for device in range(0,4):
            self.test_data["device{}".format(device)] = {}
            print("Trying to open spidev{}.{}".format(bus, device))
            self.conn.send("Checking results for device {}".format(device))
            ...
            if result1 > 0.01:
                passed_list[0] = False
            self.test_data["device{}".format(device)]["test_1"] = {"Passed": passed_list[0], "Result": f'{result1:.3f} volts', "Raw_Result": str(thisADS124.read_data())}
            
            print(self.test_data["device{}".format(device)]["test_1"])
            print('-------------------------------------------------------')
            ...
            if result2 >= 100 or result2 <= 80:
                passed_list[1] = False
            self.test_data["device{}".format(device)]["test_2"] = {"Passed": passed_list[1], "Result": f'{result2:.3f} degrees (F)', "Raw_Result": str(thisADS124.read_data())}
            print(self.test_data["device{}".format(device)]["test_2"])
            print('-------------------------------------------------------')
            ...
            if result3 >= 0.84 or result3 <= 0.82:
                passed_list[2] = False
            self.test_data["device{}".format(device)]["test_3"] = {"Passed": passed_list[2], "Result": f'{result3:.3f} volts', "Raw_Result": str(thisADS124.read_data())}
            print(self.test_data["device{}".format(device)]["test_3"])
            print('-------------------------------------------------------')
            ...
            if result4 >= 0.84 or result4 <= 0.82:
                passed_list[3] = False
            self.test_data["device{}".format(device)]["test_4"] = {"Passed": passed_list[3], "Result": f'{result4:.3f} volts', "Raw_Result": str(thisADS124.read_data())}
            print(self.test_data["device{}".format(device)]["test_4"])
            print('-------------------------------------------------------')
            ...
            #if result5 >= 0.002 or result5 <= 0.0001:
            #    passed_list[4] = False
            #self.test_data["device{}".format(device)]["test_5"] = {"Passed": passed_list[4], "Result": f'{result5:.4f} volts', "Raw_Result": str(thisADS124.read_data())}
            #print(self.test_data["device{}".format(device)]["test_5"])
            #print('-------------------------------------------------------')
            ...
            #if result6 >= 0.01 or result6 <= 0.001:
            #    passed_list[5] = False
            #self.test_data["device{}".format(device)]["test_6"] = {"Passed": passed_list[5], "Result": f'{result6:.4f} volts', "Raw_Result": str(thisADS124.read_data())}
            #print(self.test_data["device{}".format(device)]["test_6"])
            ...
            #    passed_list[6] = False
            #self.test_data["device{}".format(device)]["test_7"] = {"Passed": passed_list[6], "Result": f'{result7:.4f} volts', "Raw_Result": str(thisADS124.read_data())}
            #print(self.test_data["device{}".format(device)]["test_7"])

            self.test_data["device{}".format(device)]["device_passed"] = all(passed_list)
            self.passed &= all(passed_list)
            
            #thisADS124.powerdown()
            #thisADS124.wakeup()
            #thisADS124.reset()
            #print('resetting POR flag')
            #thisADS124.reset_POR_flag()
        ...
        print(self.passed, self.test_data)
