...
class ADS124:
    ...
    def set_gain(self, gain=1, enable=True):
        ...
        if enable:
            setting = setting|(1<<3)
            gain_power = int(round(math.log(gain,2)))
    ...
    def ref_monitor(self,config=0):
        ...
        #   3: FL_REF_L0 monitor and 10-M Ohms pull-together enabled, threshold 0.3 V
    ...
    def sys_monitor_config(self, config=0):
        ...
        config  0: Disabled (default)
                ...
                5: Burn-out current sources enabled, 0.2-mu A setting
                6: Burn-out current sources enabled, 1-mu A setting
                7: Burn-out current sources enabled, 10-mu A setting
        """
